<aside class="sidebar">
    ...
    <ul class="nav flex-column sidebar-nav ">
        ...
        <li class="nav-item ">
            <?php 
            $isForumPage = ($pageName == 'manageForum') || ($pageName == 'managePosts') || ($pageName == 'manageCategories')|| ($pageName == 'manageAchievements')
            ?>
            <div class="d-flex align-items-center fs-5">
            <i class="bi bi-file-text"></i>
                <a class="nav-link fw-bold" data-bs-toggle="collapse" href="#forumMenu" role="button" aria-expanded="false">
                    <span>論壇管理</span>
                </a>
            </div>
            <div class="collapse <?= $isForumPage ? 'show' : '' ?>" id="forumMenu">
                <ul class="list-group ">
                    <a class="list-group-item bg-light fs-6 d-flex align-items-center <?= $pageName == 'manageForum' ? 'active' : '' ?>" href="test06.php">
                    <i class="bi bi-bar-chart-line me-2"></i>
                        <span>論壇儀表板</span>
                    </a>
                    <a class="list-group-item bg-light fs-6 d-flex align-items-center <?= $pageName == 'managePosts' ? 'active' : '' ?>" href="test07.php">
                    <i class="bi bi-journal-text me-2"></i>
                        <span>文章管理</span>
                    </a>
                    <a class="list-group-item bg-light fs-6 d-flex align-items-center <?= $pageName == 'manageCategories' ? 'active' : '' ?>" href="test08.php">
                    <i class="bi bi-tags me-2"></i>
                        <span>分類管理</span>
                    </a>
                    <a class="list-group-item bg-light fs-6 d-flex align-items-center <?= $pageName == 'manageAchievements' ? 'active' : '' ?>" href="test09.php">
        ...
        <li class="nav-item">
            <div class="d-flex align-items-center">
                ...
                <a class="nav-link" data-bs-toggle="collapse" href="#forumMenu" role="button" aria-expanded="false"></a>
            </div>
            <div class="collapse" id="forumMenu">
                <ul class="list-group">
                <a class="list-group-item bg-light fs-6 <?= $pageName == 'manage_forum' ? 'active' : '' ?>"
